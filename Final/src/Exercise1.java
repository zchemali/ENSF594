...
public class Exercise1 {
	/**
	 * Swapping two elements at a time, last elements every pass is the biggest
	 * my own implementation  by understanding how the algorithm work
	 * @param array
	 */
	...
	/**
	 * two loops , first loop goes from 1st to length-1 of the array and choose the elments and put it in 
	 ...
	 * The merge sort is divide and coqur, kepp dividing unti lyou end up with 2 or 1 elments
	 * then merge them
	 * @param arrayint
	 * @param l
	 * @param r
	...
	public void mergeSort(int[] array ,int l, int r) {
		...
		if( r>l) {
			...
			//invoke Merge when elemnts of both left/right section are 1 or 2
			merge(array,l,m,r);
		}
...
//		System.out.println("LEFT"+Arrays.toString(leftArray)+"  Right"+Arrays.toString(rightArray));
		...
		//copy remainder of left array if any Note: in case you have one elemnt only
		while(i<leftArray.length) {
			array[k]=leftArray[i];
			i++;
			k++;
		}
		//copy remainder of left array if any Note: incase you have one elemnt only
